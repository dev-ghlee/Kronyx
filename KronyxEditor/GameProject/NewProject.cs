...
namespace KronyxEditor.GameProject
{
    ...
    class NewProject : ViewModelBase
    {
        ...
        private readonly string _templatePath = @"..\..\KronyxEditor\ProjectTemplates\";
        ...
        public string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\KronyxProjects\";
        ...
        private bool _isValid; // indicate name or path is valid
        public bool IsValid
        {
            get => _isValid;
            set
        ...
        private bool ValidateProjectProperties() // Check whether it is valid or not
        {
        ...
        public string CreateProject(ProjectTemplate template)
        {
            ...
            try
            {
                ...
                var dirInfo = new DirectoryInfo(path + @".Kronyx\"); // TODO : should be existed before add attribute..?
